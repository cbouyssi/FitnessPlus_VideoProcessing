...
def createDatabase():
    ...
    addExercice(clientCollection,"op2jBYRJKHde6Brk2Obbar1sisi2","traction",36,date,5)
    addExercice(clientCollection,"op2jBYRJKHde6Brk2Obbar1sisi2","traction",54,date,7)
    addExercice(clientCollection,"op2jBYRJKHde6Brk2Obbar1sisi2","pompe",94,date,20)
    addExercice(clientCollection,"op2jBYRJKHde6Brk2Obbar1sisi2","pompe",110,date,25)
    addExercice(clientCollection,"op2jBYRJKHde6Brk2Obbar1sisi2","nothing",300,date,10)

    date =  datetime(2018, 11, 26)
    addExercice(clientCollection,"op2jBYRJKHde6Brk2Obbar1sisi2","traction",74,date,10)
    addExercice(clientCollection,"op2jBYRJKHde6Brk2Obbar1sisi2","traction",54,date,10)
    addExercice(clientCollection,"op2jBYRJKHde6Brk2Obbar1sisi2","pompe",96,date,25)
    addExercice(clientCollection,"op2jBYRJKHde6Brk2Obbar1sisi2","pompe",124,date,30)
    ...
    addExercice(clientCollection,"op2jBYRJKHde6Brk2Obbar1sisi2","traction",54,date,10)
    addExercice(clientCollection,"op2jBYRJKHde6Brk2Obbar1sisi2","traction",84,date,10)
    ...
    addExercice(clientCollection,"op2jBYRJKHde6Brk2Obbar1sisi2","pompe",94,date,20)
    addExercice(clientCollection,"op2jBYRJKHde6Brk2Obbar1sisi2","pompe",54,date,30)
    # addExercice(clientCollection,"op2jBYRJKHde6Brk2Obbar1sisi2","pompe",94,date,1)
    addExercice(clientCollection,"op2jBYRJKHde6Brk2Obbar1sisi2","traction",54,date,10)
    addExercice(clientCollection,"op2jBYRJKHde6Brk2Obbar1sisi2","traction",94,date,15)
